...
data class OptionsAddPostFragmentArgs(
  ...
  companion object {
    @JvmStatic
    fun fromBundle(bundle: Bundle): OptionsAddPostFragmentArgs {
      bundle.setClassLoader(OptionsAddPostFragmentArgs::class.java.classLoader)
      ...
      return OptionsAddPostFragmentArgs(__placeType)
    }
  }
}
