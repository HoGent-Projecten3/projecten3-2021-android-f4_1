...
data class TextPostToevoegenFragmentArgs(
  ...
  companion object {
    @JvmStatic
    fun fromBundle(bundle: Bundle): TextPostToevoegenFragmentArgs {
      bundle.setClassLoader(TextPostToevoegenFragmentArgs::class.java.classLoader)
      ...
      return TextPostToevoegenFragmentArgs(__placeType)
    }
  }
}
