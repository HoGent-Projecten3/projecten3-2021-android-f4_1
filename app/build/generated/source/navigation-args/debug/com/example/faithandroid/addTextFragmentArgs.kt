...
data class addTextFragmentArgs(
  ...
  companion object {
    @JvmStatic
    fun fromBundle(bundle: Bundle): addTextFragmentArgs {
      bundle.setClassLoader(addTextFragmentArgs::class.java.classLoader)
      ...
      return addTextFragmentArgs(__placeType)
    }
  }
}
