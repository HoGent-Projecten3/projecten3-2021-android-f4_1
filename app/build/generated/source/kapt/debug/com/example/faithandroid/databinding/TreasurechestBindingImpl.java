...
public class TreasurechestBindingImpl extends TreasurechestBinding  {
    ...
    public TreasurechestBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private TreasurechestBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.google.android.material.floatingactionbutton.FloatingActionButton) bindings[2]
            , (androidx.recyclerview.widget.RecyclerView) bindings[1]
            );
        this.TreasureChestRecycler.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            com.example.faithandroid.BindingAdaptersKt.bindRecyclerViewPost(this.TreasureChestRecycler, viewModelPostListGetValue);
        }
    }
