...
public class AddPhotoBindingImpl extends AddPhotoBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.linLay1, 3);
        sViewsWithIds.put(R.id.iconPhoto, 4);
        sViewsWithIds.put(R.id.IconFolder, 5);
        sViewsWithIds.put(R.id.dropdownPlaatsen, 6);
        sViewsWithIds.put(R.id.titleFieldImage, 7);
        sViewsWithIds.put(R.id.titelImage, 8);
        sViewsWithIds.put(R.id.fotoToevoegenButton, 9);
    }
    // views
    @NonNull
    ...
    public AddPhotoBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private AddPhotoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.addImageRecyclerView.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            com.example.faithandroid.BindingAdaptersKt.bindRecyclerViewFilteredPost(this.addImageRecyclerView, viewModelPostListFilteredGetValue);
        }
    }
